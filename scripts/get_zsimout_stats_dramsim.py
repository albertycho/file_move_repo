...
f_mem_lat.write('\nwr_lat_avg, '+ "{0:.1f}".format(wr_lat_avg)
+',\n')
f_mem_lat.write('rd_lat_avg, '+ "{0:.1f}".format(rd_lat_avg)
+',\n')
f_mem_lat.write('all_lat_avg, '+ "{0:.1f}".format(all_lat_avg)+',\n')
...
f_mem_lat.write('IPC_ALL: '+ "{0:.6f}".format(ipc_all)+',\n')

f_mem_lat.write('CPI_ALL: '+str(cpi_all)+',\n')
...
#f_sss.write('all_lat_avg, '+str(all_lat_avg)+',\n')
#f_sss.write('IPC_ALL: '+str(ipc_all)+',\n')
f_sss.close()
