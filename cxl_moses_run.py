...
home = '/home/azureuser/CXL_WD/zSim'
#home = '/nethome/acho44/zsim/1027_zSim'


moses_path = '/home/azureuser/CXL_WD/Tailbench/tailbench/moses/'
pcommand = '"/home/azureuser/CXL_WD/Tailbench/tailbench/moses/bin/moses_integrated -config moses.ini -input-file /home/azureuser/CXL_WD/WD/tailbench.inputs/moses/testTerms -threads 1 -num-tasks 10000 -verbose 0";'
...
parser.add_argument('--zsim_dir', type=str, default='/home/azureuser/CXL_WD/zSim')
...
os.system('cp /home/azureuser/CXL_WD/'+confile+' .')
...
while line:
	...
	#    f2.write(tmp+'= '+mem_controllers+';\n')
        ...
        #elif 'contentionThreads' in line:
	#    tmp = line.split('=')[0]
	#    f2.write(tmp+'= '+mem_controllers+';\n')
...
for i in range(0,num_server_int,1):
    ...
    f2.write('env = "TBENCH_WARMUPREQS=0 TBENCH_RANDSEED='+str(i)+'";\n')
    #f2.write('ffiPoints = "4400000000 300000000";\n')
    ffip1 = 4400000000 + 100000*i
    ffi_line = 'ffiPoints = "' + str(ffip1)+' 200000000";\n'
    f2.write(ffi_line);
