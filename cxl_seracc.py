...
parser.add_argument('--base_cfg', type=str, default='AMD_DDR5_base_1109_BWLAT.cfg')
...
os.system ('cp '+zsim_dir+'/sweeper_tests/ser_access_st .')
...
for i in range(0,num_server_int,1):
    ...
    #f2.write('ffiPoints = "600000000 250000000";\n')
    f2.write('startFastForwarded = True;\n')
    f2.write('    command = "./ser_access_st"\n')
    f2.write('};\n')
